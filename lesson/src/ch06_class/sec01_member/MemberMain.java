...
//		james.email = "james@naver.com";		// 접근제한자가 private 이라 불가능
		...
		james.setBrithday(LocalDate.of(2001, 11, 19));
		
		// 메소드 사용
		System.out.println(james);				// james.toString()
		System.out.println(maria.toString());
		
		System.out.println(james.name + ": " + james.getBrithday() + ", " + james.getAge());
		System.out.println(maria.name + ": " + maria.getBrithday() + ", " + maria.getAge());
	}
